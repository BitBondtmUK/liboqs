...
static void randombytes_internal(unsigned char *random_array, unsigned int nbytes) { // Generation of "nbytes" of random values
...
void randombytes(unsigned char *random_array, unsigned int nbytes) { // Generation of "nbytes" of random values
