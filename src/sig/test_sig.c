...
struct sig_testcase sig_testcases[] = {
    ...
    {OQS_SIG_algid_picnic_L1_FS, "picnic_L1_FS", 0, 10},
    {OQS_SIG_algid_picnic_L1_UR, "picnic_L1_UR", 0, 10},
    {OQS_SIG_algid_picnic_L3_FS, "picnic_L3_FS", 0, 10},
    {OQS_SIG_algid_picnic_L3_UR, "picnic_L3_UR", 0, 10},
    {OQS_SIG_algid_picnic_L5_FS, "picnic_L5_FS", 0, 10},
    {OQS_SIG_algid_picnic_L5_UR, "picnic_L5_UR", 0, 10},
#endif
#ifdef ENABLE_SIG_QTESLA
    {OQS_SIG_algid_qTESLA_I, "qTESLA_I", 0, 10},
    {OQS_SIG_algid_qTESLA_III_speed, "qTESLA_III_speed", 0, 10},
    {OQS_SIG_algid_qTESLA_III_size, "qTESLA_III_size", 0, 10},
#endif
};
